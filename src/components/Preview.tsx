...
import type { OutputSizeId, FormData, TextLayoutSettings } from '../types';
...
export function Preview({ 
  ...
  // ドラッグ機能
  const { dragging, handleMouseDown, handleMouseMove, handleMouseUp } = useTextDrag({
    canvasRef,
    formData,
    textLayout,
    onLayoutChange,
  ...
  return (
    <div className="w-full">
      ...
      >
        ...
        <canvas
          ref={canvasRef}
          className={`w-full h-full object-contain ${dragging ? 'cursor-move' : 'cursor-pointer'}`}
